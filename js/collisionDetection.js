...
exports.a = function (self, exclude) {
    exclude = exclude || [];
    var selfCollisionBoundary = self.gcb(),
    ...
    for (var i = 0; i < otherCollisionObjects.length; i++) {
        isColliding = circleDetection(selfCollisionBoundary, otherCollisionObjects[i].object.gcb());
...
exports.b = function (body, radius) {
    return function () {
